...
<%@page import="com.miempres.conexion.ConexionBD"%>
...
<html>
    <head>
        ...
        <link rel="icon" type="image/jpg" href="recursos/img/listaP.png" />
                            ...
                            <div class="row cardmodulos">
                                ...
                                <div class="col-12 col-lg-10">
                                    <div class="nuevosproductos"> 
                                        ...
                                        <div class="nuevo">
                                            <a href="mproductos/newpreguntas.jsp"><button type="button" class="btn btn-success"><i class="fas fa-plus"></i>&nbsp;Agregar preguntas</button></a>
                                    <%
                                       ConexionBD con = new ConexionBD();
                                       Statement smt = con.getCon().createStatement();
                                       ResultSet rs=smt.executeQuery("select*from preguntasP");
                                        %>
                                        ...
                                        <%
                                                    String busc = request.getParameter("txtBusca");
                                                    if(busc!=null){
                                                        smt=con.getCon().createStatement();
                                                        rs=smt.executeQuery("select*from preguntasP where dificultad like "+"'%"+busc+"%'");
                                                    }
                                                    else{
                                        ...
                                        <div class="card-body">
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="preguntas" items="${sessionScope.preguntas}">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="checkbox" name="opc" VALUE="${preguntas.id}" /></td>
                                                        </tr>
                                                    </c:forEach>
                                                ...
                                                <div class="banner-caption text-center">
                                                    <a class="btn btn-success" href="<%=request.getContextPath()%>/preguntacontroller.do?txtAccionp=seleccionar&id=<%=request.getParameterValues("opc")%>" role="button"><i class="fas fa-edit"></i></a>
                                        </div>
                                            </table>

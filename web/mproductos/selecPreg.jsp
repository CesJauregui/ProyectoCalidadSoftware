                        ...
                        <div class="col-5" col-lg-4>
                            <div class="card">
                                <div class="card-header">
                                    <h5 align="center">Examen</h5>
                                </div>
                                <form class="card-body" action="<%=request.getContextPath()%>/preguntacontroller.do?txtAccion=updatep" method="post">                                              
                                    <div class="form-group">

                                        <input class="form-control" id="txtPregunta" type="text" name="txtPregunta" placeholder="Pregunta" value="<%=preguntaoDto.getPregunta()%>"></input>
                                    ...
                                    <a href="#ventana1" class="btn btn-primary btn-block" data-toggle="modal">Guardar Examen</a>
